...
namespace CSII_Clock
{
    public class Mod : IMod
    {
        public const string MOD_NAME = "Clock";
        public const string MOD_UI = "Clock";
        public static ILog log = LogManager.GetLogger($"{nameof(CSII_Clock)}.{nameof(Mod)}").SetShowsErrorsInUI(false);
        ...
        public void OnLoad(UpdateSystem updateSystem)
        {
            ...
            AssetDatabase.global.LoadSettings(nameof(CSII_Clock), m_Setting, new Setting(this));
        }
